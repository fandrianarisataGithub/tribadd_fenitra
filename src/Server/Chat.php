...
class Chat implements MessageComponentInterface
{
    ...
    public function onMessage(ConnectionInterface $conn, $message)
    {
        ...
        switch ($action) {
            ...
            case 'unsubscribe':
                ...
                return true;
            case 'message':
                return $this->sendMessageToChannel($conn, $channel, $user, $message, $photo);
            default:
     ...
     */
    private function sendMessageToChannel(ConnectionInterface $conn, $channel, $user, $message, $photo)
    {
